  ...
  return (
    <section className="py-20 select-none">
      <div className="mx-auto max-w-6xl px-4">
        <h2 className="mb-24 text-center font-serif italic text-3xl md:text-[38px] text-[#2d2d2d] tracking-wide font-taprom">
        ...
        <div className="flex items-center justify-between gap-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 max-w-3xl w-full mx-6">
            ...
            <div className="relative flex-1 py-4 px-10">
              <span className="absolute -left-5 top-[-8px] select-none">
              ...
              <p className="text-[1.2vw] text-[#2b2b2b] leading-[1.6] min-h-[60px] md:text-[16px]">
                {current.quote}
              </p>

              <span className="absolute -right-4 bottom-0 select-none">
                <div className="relative w-[2.9vw] h-[2.05vw] min-w-[25px] min-h-[18px]">
                  <Image
                    src="/LeftQuote.svg"
                    alt="Quote End"
