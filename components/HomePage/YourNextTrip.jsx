    ...
    <section className="overflow-hidden py-[5vw]">
      <div className="mx-auto w-[95%]">
        <div className="text-center">
          ...
          <p className="mx-auto mt-[1vw] max-w-[43vw] text-[0.92vw] leading-[1.8] text-[#6D6D6D]">
        ...
        <div className="mt-[4vw]">
          <div className="mb-[1vw] flex justify-center">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="#2D3482">
          ...
          <div className="border-b border-[#D8D8D8]">
            <div className="flex items-center justify-center gap-[4vw] text-[1vw]">
              <button className="relative pb-[1vw] font-medium text-black">
                Journeys We Love
                <span className="absolute bottom-0 left-0 h-[1.5px] w-full bg-black" />
              </button>

              <button className="pb-[1vw] text-[#707070]">
