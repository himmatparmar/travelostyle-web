...
const routeDays = [
  {
    ...
    styles: "absolute left-[3.5%] top-[105px] w-[215px] -rotate-[8deg] z-30 shadow-[5px_12px_30px_rgba(0,0,0,0.15)] border-neutral-200/80",
    aspect: "aspect-[4/3.4]",
  ...
  },
  {
    ...
    styles: "absolute left-[16.5%] top-[20px] w-[200px] rotate-[2deg] z-10 shadow-[2px_10px_26px_rgba(0,0,0,0.12)] border-neutral-200/60",
    aspect: "aspect-[4/3.4]",
    textSize: "text-[11px]",
    padding: "p-3 pb-5"
  },
  {
    ...
    styles: "absolute left-[24%] top-[140px] w-[205px] -rotate-[5deg] z-40 shadow-[6px_16px_34px_rgba(0,0,0,0.16)] border-neutral-200",
    aspect: "aspect-[4/3.4]",
    textSize: "text-[11.5px]",
    padding: "p-3.5 pb-5.5"
  },
  {
    ...
    styles: "absolute left-[36%] top-[5px] w-[255px] rotate-[0deg] z-20 shadow-[0_20px_42px_rgba(0,0,0,0.15)] border-neutral-200/90",
    aspect: "aspect-[4/3.5]",
    textSize: "text-[13px]",
    padding: "p-4 pb-7"
  },
  {
    ...
    styles: "absolute left-[50%] top-[135px] w-[205px] -rotate-[7deg] z-30 shadow-[4px_13px_30px_rgba(0,0,0,0.13)] border-neutral-200/70",
    aspect: "aspect-[4/3.4]",
    textSize: "text-[11.5px]",
    padding: "p-3.5 pb-5.5"
  },
  {
    ...
    styles: "absolute left-[60.5%] top-[20px] w-[195px] rotate-[6deg] z-40 shadow-[5px_13px_32px_rgba(0,0,0,0.14)] border-neutral-200/70",
    aspect: "aspect-[4/3.4]",
    textSize: "text-[11px]",
    padding: "p-3 pb-5"
  },
  {
    ...
    styles: "absolute left-[73.5%] top-[-40px] w-[240px] rotate-[1.5deg] z-20 shadow-[4px_16px_38px_rgba(0,0,0,0.14)] border-neutral-200",
    aspect: "aspect-[4/3.6]",
    ...
    <div className="w-full min-h-[800px] bg-white relative flex flex-col items-center py-16 overflow-hidden select-none">
      ...
      <div className="w-full max-w-[1280px] h-[480px] relative z-20 mx-auto px-4 flex items-center justify-start">
        ...
        {routeDays.map((item, index) => (
          ...
          >
            <div className={`w-full overflow-hidden border border-neutral-200 rounded-3xs ${item.aspect}`}>
              <img 
                src={item.img} 
                alt={item.day} 
            ...
            <div className={`mt-4.5 text-center font-black text-[#111] tracking-widest uppercase ${item.textSize}`}>
              {item.day}
            </div>
          </div>
        ))}
