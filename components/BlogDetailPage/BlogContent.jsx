...
<p className="mt-[24px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  From Delhi, the journey continues to Agra, home to one of the most admired monuments in the world: the Taj Mahal.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  No photograph truly prepares you for seeing it in person. The first glimpse of its white marble dome feels almost unreal. Whether seen at sunrise, when the light is soft and golden, or later in the day, when the marble glows against the sky, the Taj Mahal has a quiet beauty that stays with you.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  But Agra is more than just the Taj Mahal. Agra Fort is another incredible highlight, with its red sandstone walls, courtyards, and views across the Yamuna River. The city also offers glimpses of Mughal craftsmanship, marble inlay work, local markets, and traditional sweets like petha.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  Agra brings a sense of romance and wonder to the Golden Triangle. It is the part of the journey where history feels emotional, personal, and grand.
</p>
...
<p className="mt-[24px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  The final stop is Jaipur, Rajasthan's famous Pink City. If Delhi is energetic
  and Agra is poetic, Jaipur is royal, colourful, and full of character.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  The city is known for its magnificent forts, palaces, textiles, jewellery,
  and vibrant markets. Amber Fort is one of the most striking experiences of
  the trip, rising beautifully against the hills. The City Palace gives a
  glimpse into royal life, while Hawa Mahal, with its delicate honeycomb-like
  façade, is one of Jaipur's most photographed landmarks.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  Jaipur is also a paradise for shopping and design lovers. From block-printed
  fabrics and blue pottery to gemstones, traditional juttis, and handcrafted
  souvenirs, the city is full of artistry. Even the streets feel visually rich,
  with their pink-toned buildings, decorated doors, and busy bazaars. There is
  a warmth to Jaipur that makes it a wonderful final chapter of the journey. It
...
<p className="mt-[24px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  What makes the Golden Triangle so special is the variety it offers in a
  short period of time. In one trip, you experience three very different
  cities, each with its own personality.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  Delhi gives you history, culture, and the excitement of a capital city.
  Agra gives you one of the world's most beautiful monuments and a powerful
  sense of Mughal heritage. Jaipur gives you royal architecture, colour,
  craft, and the charm of Rajasthan.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  Together, they create a complete and deeply satisfying travel experience.
</p>

<p className="mt-[28px] text-[18px] leading-[36px] tracking-[0.05em] text-[#1A1A1A]">
  The route is also very convenient, especially for first-time visitors to
  India. The distances between the cities are manageable, the road and rail
  connections are well established, and the itinerary can be comfortably
  completed in around five to seven days. For travellers who want a strong
  first impression of India without feeling overwhelmed by too much distance,
  the Golden Triangle is ideal.
</p>
...
<div className="mt-[72px] flex items-center justify-between">
          ...
          <h3 className="mt-[34px] text-[24px] font-semibold leading-[40px] text-[#1A1A1A]">
            ...
            >
              ...
              <div className="flex items-center justify-between px-[16px] py-[14px]">
                ...
                <button className="flex h-[31px] items-center justify-center rounded-full border border-[#1A1A1A] bg-white px-[16px] text-[12px] font-Nohemi text-[#1A1A1A]">
                  Experiences
                </button>
              </div>
  ...
  <Image
    ...
    width={524}
    height={296}
    className="w-[524px] h-[296px] object-cover"
  />
</div>
              {/* Title */}
              <div className="px-[16px] pt-[16px] min-h-[170px]">
...
<div className="mt-[32px]">
  ...
  {/* Button */}
  <button
  className="mt-[24px] h-[45px] rounded-[100px] bg-[#2C3078] px-[21px] text-[16px] font-medium text-white"
>
  Subscribe
</button>
</div>
