...
const FALLBACK_MATRIX = {
  ...
  topIntroText:
    "TravelOStyle will ask the right questions, understand how you like to move, what you're hoping to feel, what you absolutely cannot compromise on, and what you'd happily leave behind. Then we craft your perfect journey.",
  footerText:
    "Journeys that begin with you. Where you want to go. How long you want to travel. What season works. Who's coming? What pace feels right. What kind of stay you want. What the trip needs to do for you",
  features: [
    {
